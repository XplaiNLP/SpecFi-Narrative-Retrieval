...
# Preprocess for BM25
# Tokenize texts into simple whitespace tokens
tokenized_corpus = [doc.lower().split() for doc in texts]
bm25 = BM25Okapi(tokenized_corpus)

Ks = [1, 2, 3, 10, 20, 100, 500, 1000, 1500, 2000, 2500, lowest_count]

fails = ['2_1', '3_2', '3_3', '4_4', '4_5', '5_1', '5_3', '6_2', '6_4', '7_3', '7_6', '8_2', '8_3', '9_2', '10_2', '10_4', '10_5', '12_1', '13_1', '14_2', '15_1', '15_2', '15_3', '15_4', '15_6', '15_7', '15_8', '16_3', '16_5', '18_2', '18_4', '20_1', '20_2', '20_3', '20_4', '20_5', '21_2']
...
for narrative_id, subnarratives in tqdm(taxonomy.items(), desc=f"Processing {model_name}"):
    if narrative_id in fails: continue
    ...
    for subnarrative in subnarratives:
        query_tokens = subnarrative.lower().split()
        scores = bm25.get_scores(query_tokens)
        ranked_indices = np.argsort(scores)[::-1]
        correct_hits = []
        for idx in ranked_indices:
            claim_string = claims[idx]
...
print(model_row['Overall_R-Precision'])
total_tp_weighted = 0
