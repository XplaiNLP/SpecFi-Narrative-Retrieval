...
if RUN_OPTION == "NodeRAG":
    ...
    config = NodeConfig.from_main_folder(r"./noderag_pn_training")
...
def get_hyde_emb(query):
    ...
    sims = torch.nn.functional.cosine_similarity(
        query_embedding.unsqueeze(0), text_embeddings_local, dim=1
    )
...
if RUN_OPTION == "DR":
    ...
    for el in taxonomy:
        ...
        if el not in not_in_dataset:
            ...
            all_hypos[narrative] = ""
            top_1 = get_hyde_emb_local(
                narrative, text_embeddings_training, texts_training
            )
